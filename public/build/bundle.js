...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "header-center");
    			attr_dev(div, "class", "svelte-o741x9");
    			add_location(div, file$3, 8, 8, 97);
    			attr_dev(header, "id", "header");
    			attr_dev(header, "class", "svelte-o741x9");
    			add_location(header, file$3, 7, 3, 68);
    			add_location(main, file$3, 6, 0, 58);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = `Hello from ${/*from*/ ctx[0]}!`;
    			t3 = space();
    			p = element("p");
    			p.textContent = "this is the subtitle";
    			add_location(h1, file$2, 14, 8, 263);
    			add_location(p, file$2, 15, 8, 299);
    			attr_dev(div, "id", "container");
    			attr_dev(div, "class", "svelte-scxz3i");
    			add_location(div, file$2, 13, 4, 234);
    			add_location(main, file$2, 12, 0, 223);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, getData, from });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main1, file$1, 7, 0, 110);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
