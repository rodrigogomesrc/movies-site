...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 13, 8, 198);
    			add_location(button, file$5, 14, 8, 266);
    			attr_dev(div, "id", "subscribe");
    			attr_dev(div, "class", "svelte-1tn5ke9");
    			add_location(div, file$5, 12, 4, 169);
    			add_location(main, file$5, 11, 0, 158);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Subscribe extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { subscribe: 2 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$3, 40, 4, 1116);
    			add_location(h20, file$3, 43, 12, 1232);
    			add_location(h21, file$3, 45, 12, 1320);
    			attr_dev(div0, "id", "left-side");
    			attr_dev(div0, "class", "side svelte-debqk4");
    			add_location(div0, file$3, 42, 8, 1186);
    			add_location(h22, file$3, 52, 12, 1555);
    			attr_dev(div1, "id", "right-side");
    			attr_dev(div1, "class", "side svelte-debqk4");
    			add_location(div1, file$3, 51, 8, 1508);
    			attr_dev(div2, "id", "sides-holder");
    			attr_dev(div2, "class", "svelte-debqk4");
    			add_location(div2, file$3, 41, 4, 1154);
    			add_location(main, file$3, 39, 0, 1105);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
