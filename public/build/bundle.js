...
var app = (function () {
    ...
    const subscribeToGenre = async (genre) => {
    ...
    const unsubscribeFromGenre = async (genre) => {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$8, 16, 4, 307);
    			add_location(main, file$8, 15, 0, 296);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$6, 13, 8, 198);
    			add_location(button, file$6, 14, 8, 266);
    			attr_dev(div, "id", "subscribe");
    			attr_dev(div, "class", "svelte-1tn5ke9");
    			add_location(div, file$6, 12, 4, 169);
    			add_location(main, file$6, 11, 0, 158);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Subscribe extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { subscribe: 2 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$5, 10, 37, 192);
    			attr_dev(div0, "class", "movie-title svelte-16gb3ti");
    			add_location(div0, file$5, 10, 12, 167);
    			attr_dev(div1, "class", "movie-genre svelte-16gb3ti");
    			add_location(div1, file$5, 11, 12, 241);
    			attr_dev(div2, "class", "movie-channel svelte-16gb3ti");
    			add_location(div2, file$5, 12, 12, 298);
    			attr_dev(div3, "class", "movie-date svelte-16gb3ti");
    			add_location(div3, file$5, 13, 12, 359);
    			attr_dev(div4, "class", "movie-notification svelte-16gb3ti");
    			add_location(div4, file$5, 9, 8, 122);
    			add_location(button, file$5, 16, 12, 479);
    			attr_dev(div5, "class", "notification-close");
    			add_location(div5, file$5, 15, 8, 434);
    			attr_dev(div6, "class", "notification svelte-16gb3ti");
    			add_location(div6, file$5, 8, 4, 87);
    			add_location(main, file$5, 7, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Notification extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { delNotification: 0, movie: 1 });
    ...
    // (47:12) {#each subscriptions as genre, index}
    function create_each_block_1(ctx) {
    	...
    	subscription = new Subscription({
    			props: {
    				genre: /*genre*/ ctx[8],
    				unsubscribe: /*delSubscription*/ ctx[3]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*subscriptions*/ 2) subscription_changes.genre = /*genre*/ ctx[8];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:12) {#each subscriptions as genre, index}",
    		ctx
    	});
    ...
    // (55:12) {#each notifications as notification, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*notifications*/ 1) notification_changes.movie = /*notification*/ ctx[5];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:12) {#each notifications as notification, index}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	subscribe_1 = new Subscribe({
    			props: { subscribe: /*subscribe*/ ctx[4] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$3, 40, 4, 1140);
    			add_location(h20, file$3, 43, 12, 1256);
    			add_location(h21, file$3, 45, 12, 1344);
    			attr_dev(div0, "id", "left-side");
    			attr_dev(div0, "class", "side svelte-debqk4");
    			add_location(div0, file$3, 42, 8, 1210);
    			add_location(h22, file$3, 52, 12, 1579);
    			attr_dev(div1, "id", "right-side");
    			attr_dev(div1, "class", "side svelte-debqk4");
    			add_location(div1, file$3, 51, 8, 1532);
    			attr_dev(div2, "id", "sides-holder");
    			attr_dev(div2, "class", "svelte-debqk4");
    			add_location(div2, file$3, 41, 4, 1178);
    			add_location(main, file$3, 39, 0, 1129);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*subscriptions, delSubscription*/ 10) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	return [notifications, subscriptions, delNotification, delSubscription, subscribe];
    }
