...
var app = (function () {
    ...
    // (49:12) {#each subscriptions as genre, index}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*subscriptions*/ 4) subscription_changes.genre = /*genre*/ ctx[9];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:12) {#each subscriptions as genre, index}",
    		ctx
    	});
    ...
    // (57:12) {#each notifications as notification, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*notifications*/ 2) notification_changes.movie = /*notification*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:12) {#each notifications as notification, index}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 25, 4, 449);
    			add_location(main, file$2, 24, 0, 438);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
